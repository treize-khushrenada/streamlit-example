...
def main():
    ...
    st.markdown('# '+str(int(data['22x_OV'][1]))+" left")
    st.markdown('# 22M走')
    st.markdown('# ETA: '+str(data['22m_SFR'][0]))
    st.markdown('# '+str(int(data['22m_SFR'][1]))+" left")
    st.markdown('# 22走')
    st.markdown('# ETA: '+str(data['22_SFR'][0]))
    st.markdown('# '+str(int(data['22_SFR'][1]))+" left")
    st.markdown('# 5R走')
    st.markdown('# ETA: '+str(data['22_SFR'][0]))
    st.markdown('# '+str(int(data['22_SFR'][1]))+" left")
    st.markdown('# 22D走')
    st.markdown('# ETA: '+str(data['22d_SFR'][0]))
    st.markdown('# '+str(int(data['22d_SFR'][1]))+" left")
    st.markdown('# 22x返')
    st.markdown('# ETA: '+str(data['22x_KT'][0]))
    st.markdown('# '+str(int(data['22x_KT'][1]))+" left")
